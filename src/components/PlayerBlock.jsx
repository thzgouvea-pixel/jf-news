      ...
      <div style={{ background: "linear-gradient(160deg, #0a1220 0%, #111d33 40%, #0d1828 100%)", borderRadius: 22, overflow: "hidden", boxShadow: "0 4px 20px rgba(10,18,32,0.25)", position: "relative" }}>
        ...
        <div style={{ padding: "22px 18px 0" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: 10, alignItems: "center" }}>
            ...
            <div style={{ textAlign: "center", padding: "0 4px", minWidth: 90 }}>
              <span style={{ fontSize: 22, fontWeight: 900, color: "#fff", fontFamily: SANS, letterSpacing: "0.03em", display: "block", marginBottom: 8 }}>{matchStats.score}</span>
              ...
              {durationStr && <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.4)", fontFamily: SANS, display: "block", marginTop: 10 }}>{durationStr}</span>}
            </div>
            <div style={{ textAlign: "center" }}>

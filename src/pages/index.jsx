...
export default function JoaoFonsecaNews() {
  ...
  useEffect(function() {
    ...
    document.title = "Fonseca News · João Fonseca #" + (dp ? dp.ranking : 40) + " ATP";
    ...
    var ogTags = [["og:title", "Fonseca News · João Fonseca #" + (dp ? dp.ranking : 40) + " ATP"],["og:description", "Notícias, ranking, quiz, palpites e enquetes sobre João Fonseca. Site independente de fãs."],["og:type", "website"],["og:site_name", "Fonseca News"],["og:locale", "pt_BR"],["og:url", "https://fonsecanews.com.br"],["og:image", ogImg],["og:image:width", "1200"],["og:image:height", "630"],["twitter:card", "summary_large_image"],["twitter:site", "@JFonsecaNews"],["twitter:title", "Fonseca News · João Fonseca"],["twitter:description", "Notícias, quiz e palpites sobre o tenista brasileiro #" + (dp ? dp.ranking : 40) + " ATP"],["twitter:image", ogImg]];
    ...
    descMeta.content = "Fonseca News — Notícias, resultados, ranking, quiz e palpites sobre João Fonseca, tenista brasileiro #" + (dp ? dp.ranking : 40) + " ATP. Site independente de fãs com countdown, enquetes e calendário ATP 2026.";
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      ...
      {showRanking && (<Modal title="📈 Evolução no Ranking" subtitle="Posição ATP ao longo do tempo" onClose={function(){setShowRanking(false);}} maxWidth={650}><RankingChart currentRanking={dp ? dp.ranking : 40} /></Modal>)}

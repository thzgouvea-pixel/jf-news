...
var NextDuelCard = function(props) {
  ...
  var oppImg = match.opponent_id ? ("https://api.sofascore.app/api/v1/team/" + match.opponent_id + "/image") : (oppAtpSlug ? ("https://www.atptour.com/-/media/alias/player-headshot/" + oppAtpSlug) : null);
  var oppImgFallback = match.opponent_id ? ("https://api.sofascore.app/api/v1/team/" + match.opponent_id + "/image") : null;

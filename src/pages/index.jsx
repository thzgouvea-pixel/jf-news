...
var matchKey = (match.tournament_name || “match”).replace(/[^a-zA-Z0-9]/g, “*”) + “*” + match.date;
var *p = useState(function() { try { return JSON.parse(localStorage.getItem(“fn_pred*” + matchKey)); } catch(e) { return null; } });
var prediction = _p[0]; var setPrediction = *p[1];
var options = [
...
setPrediction(pred);
try { localStorage.setItem(“fn_pred*” + matchKey, JSON.stringify(pred)); } catch(e) {}

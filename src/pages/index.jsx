              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
                ...
                <div style={{ textAlign: "center", flex: 1 }}>
                  <div style={{ width: 48, height: 48, borderRadius: "50%", overflow: "hidden", margin: "0 auto 6px", border: "2px solid " + BORDER, background: BG_ALT }}>
                    <img src={(function() { var oid = matchStats.opponent_id; if (!oid) { var knownIds = { "Alcaraz": 819847, "Sinner": 855030, "Djokovic": 14882, "Medvedev": 370414, "Zverev": 333849, "Rublev": 340789, "Ruud": 348771, "Tsitsipas": 343533, "Fritz": 332341, "Rune": 946498, "Hurkacz": 346438, "Khachanov": 339498, "Berrettini": 348709, "Diallo": 280151, "Shelton": 974498, "Draper": 935498, "Tiafoe": 333506, "Musetti": 868786, "Fils": 1080907, "Cerundolo": 960498, "Davidovich Fokina": 800098, "Auger-Aliassime": 771498, "de Minaur": 369209, "Paul": 332333, "Tabilo": 851098, "Machac": 960097, "Mpetshi Perricard": 1034753, "Mensik": 1192397, "Shapovalov": 353206, "Munar": 345523 }; var oName = matchStats.opponent_name || ""; for (var k in knownIds) { if (oName.indexOf(k) !== -1) { oid = knownIds[k]; break; } } } return oid ? "https://api.sofascore.app/api/v1/player/" + oid + "/image" : ""; })()} alt={oppShort} style={{ width: "100%", height: "100%", objectFit: "cover" }} onError={function(e) { e.target.style.display = "none"; e.target.parentNode.innerHTML = "<span style='font-size:16px;font-weight:700;color:" + DIM + ";display:flex;align-items:center;justify-content:center;width:100%;height:100%'>" + oppShort.charAt(0) + "</span>"; }} />
                  </div>
          ...
          <section style={{ padding: "20px 0 0" }}>
            ...
            {!pushEnabled && (
              <button onClick={handlePushSubscribe} disabled={pushLoading} style={{ width: "100%", marginTop: 8, padding: "8px 16px", background: "transparent", border: "1px solid " + BORDER, borderRadius: 10, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                ...
                <span style={{ fontSize: 11, fontWeight: 600, color: SUB, fontFamily: SANS }}>{pushLoading ? "Ativando..." : "Avise-me quando o jogo começar"}</span>
              </button>
            )}
          </section>
        )}

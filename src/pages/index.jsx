...
var matchKey = “fn_pred_” + (match.tournament_name || “match”).replace(/[^a-zA-Z0-9]/g, “*”) + “*” + match.date;
...
var _reading = useState(false); var reading = _reading[0]; var setReading = *reading[1];

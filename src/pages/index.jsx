// Fonseca News — Refactored
import { useState, useEffect, useRef } from "react";
import Head from "next/head";
import { GREEN, YELLOW, BG_ALT, TEXT, SUB, DIM, BORDER, RED, SERIF, SANS, formatTimeAgo, countryFlags, getATPImage, getESPNImage } from "../components/constants";
import Navigation from "../components/Navigation";
import { NextDuelCard } from "../components/MatchCard";
import MatchCarousel, { PlayerBlock } from "../components/StatsCard";
import { ATPRankingList, RankingChart } from "../components/RankingModal";
import { Skeleton, buildFeed } from "../components/NewsCard";
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      ...
      <Navigation
        ...
        onShowRanking={function(){ setShowRanking(true); }}
        onShowCalendar={function(){ setShowCalendar(true); }}
        onShowTitles={function(){ setShowTitles(true); }}
        onShowFeedback={function(){ setShowFeedback(true); }}
        onShowRankingChart={function(){ setShowRankingChart(true); }}
        onToggleMaisMenu={function(v){ if (typeof v === "boolean") setShowMaisMenu(v); else setShowMaisMenu(!showMaisMenu); }}
      />

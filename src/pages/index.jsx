...
var InstallBanner = function() {
  var _dismissed = useState(function() { try { return localStorage.getItem("fn_install_banner") === "1"; } catch(e) { return false; } });
  var dismissed = _dismissed[0]; var setDismissed = _dismissed[1];
  ...
  return (
    <div style={{ background: "linear-gradient(145deg, #0D1726 0%, #132440 100%)", borderRadius: 14, padding: "20px", margin: "4px 0", position: "relative" }}>
      ...
      <div style={{ display: "flex", gap: 6, marginTop: 14 }}>
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 8, padding: "8px 10px", background: "rgba(255,255,255,0.04)", borderRadius: 8, border: "1px solid rgba(255,255,255,0.06)" }}>
      ...
      <div style={{ marginTop: 14, padding: "10px 14px", background: "rgba(255,255,255,0.04)", borderRadius: 10, border: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", fontFamily: SANS }}>Safari: toque em <strong style={{ color: "rgba(255,255,255,0.8)" }}>Compartilhar</strong> (↑) · Chrome: toque em <strong style={{ color: "rgba(255,255,255,0.8)" }}>⋮</strong></span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", fontFamily: SANS }}><strong style={{ color: "rgba(255,255,255,0.8)" }}>Adicionar à Tela de Início</strong></span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", fontFamily: SANS }}>Toque em <strong style={{ color: "rgba(255,255,255,0.8)" }}>Adicionar</strong> — pronto!</span>
          </div>
        </div>
      </div>
    </div>

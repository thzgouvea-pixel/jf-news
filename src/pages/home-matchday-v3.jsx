...
export default function HomeMatchdayV3() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg }}>
      <Head>
        ...
        <meta name="description" content="Homepage matchday v3" />
      </Head>

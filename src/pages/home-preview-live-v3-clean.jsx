...
export default function HomePreviewLiveV3Clean() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      <Head>
        <title>Fonseca News — Home V3</title>
        <meta name="description" content="Homepage v3 com textos mais enxutos" />
      </Head>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <span style={{ display: "block", fontSize: 10, color: DIM, fontFamily: SANS, marginTop: 1 }}>Preview v3 com textos mais enxutos</span>
            </div>
          </div>
          <span style={{ fontSize: 11, fontWeight: 700, color: "#4FC3F7", fontFamily: SANS, background: "#4FC3F710", border: "1px solid #4FC3F726", padding: "6px 10px", borderRadius: 999 }}>Preview Live V3</span>
        </div>
      </header>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                ...
                <div style={{ background: "#fff", border: `1px solid ${BORDER}`, borderRadius: 14, padding: 14 }}>
                  ...
                  <div style={{ display: "flex", gap: 5, marginTop: 6 }}>
                    {form.length ? form.map((m, i) => <span key={i} style={{ width: 22, height: 22, borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", background: m.result === "V" ? `${GREEN}14` : "#FEE2E2", color: m.result === "V" ? GREEN : "#DC2626", fontSize: 10, fontWeight: 800, fontFamily: SANS }}>{m.result}</span>) : null}
                  </div>
                </div>
              </div>
            </SoftCard>

...
var TOURNAMENT_CURIOSITIES={"monte carlo":[{icon:"🏔️",text:"Jogado num penhasco com vista pro Mediterrâneo"},{icon:"👑",text:"Nadal venceu 11 vezes — recorde absoluto"},{icon:"🎾",text:"1º Masters 1000 de saibro da temporada"},{icon:"🇲🇨",text:"Country Club: apenas 1 quadra central, 10.200 lugares"},{icon:"📜",text:"Único Masters não obrigatório no calendário ATP"}],"roland garros":[{icon:"🏟️",text:"Quadra Philippe-Chatrier tem teto retrátil desde 2020"},{icon:"👑",text:"Nadal venceu 14 vezes — maior domínio da história"},{icon:"🧱",text:"Saibro feito de pedra calcária triturada de Millau"},{icon:"📜",text:"Nomeado em homenagem a um aviador da 1ª Guerra"},{icon:"🇧🇷",text:"Guga é o único brasileiro campeão (3x)"}],"wimbledon":[{icon:"🍓",text:"28 mil kg de morangos consumidos por edição"},{icon:"🌱",text:"A grama é cortada a exatos 8mm de altura"},{icon:"👔",text:"Código de vestimenta: quase tudo branco"},{icon:"📜",text:"Torneio mais antigo do mundo: desde 1877"},{icon:"🏆",text:"Federer é o maior campeão com 8 títulos"}],"australian open":[{icon:"🌡️",text:"Temperaturas passam dos 40°C — há regra de calor"},{icon:"🏟️",text:"Rod Laver Arena tem teto retrátil desde 1988"},{icon:"🇧🇷",text:"João Fonseca estreou em Grand Slam aqui em 2025"},{icon:"🦘",text:"Único Grand Slam no hemisfério sul"},{icon:"👑",text:"Djokovic é o maior campeão com 10 títulos"}],"us open":[{icon:"✈️",text:"Quadra central na rota de aviões do LaGuardia"},{icon:"🏟️",text:"Arthur Ashe: maior quadra do mundo, 23.771 lugares"},{icon:"🌙",text:"Famoso pelas sessões noturnas em Nova York"},{icon:"💰",text:"Maior premiação de todos os Grand Slams"},{icon:"🎵",text:"Torcida tão barulhenta que incomoda veteranos"}],"madrid":[{icon:"🏔️",text:"Altitude de 650m faz a bola viajar mais rápido"},{icon:"🧱",text:"Já foi jogado em saibro azul em 2012"},{icon:"🏟️",text:"Caja Mágica: 3 quadras com teto retrátil"},{icon:"👑",text:"Nadal venceu 5 vezes no saibro de Madrid"},{icon:"♀️",text:"Um dos poucos Masters com torneio feminino"}],"roma":[{icon:"🏛️",text:"Foro Itálico: arena dos anos 1930, era Mussolini"},{icon:"🎨",text:"Estátuas de mármore ao redor das quadras desde 1928"},{icon:"👑",text:"Nadal venceu 10 vezes — recorde do torneio"},{icon:"🍕",text:"Apelidado de 'internazionali' pelos italianos"},{icon:"📜",text:"Existe desde 1930 — um dos mais antigos do circuito"}],"indian wells":[{icon:"🏜️",text:"No deserto da Califórnia, 350 dias de sol por ano"},{icon:"🏟️",text:"Stadium 1: 16.100 lugares, 2º maior do mundo"},{icon:"🌴",text:"Apelidado de 'o 5º Grand Slam' pela qualidade"},{icon:"💰",text:"Um dos torneios mais ricos fora dos Slams"},{icon:"🌅",text:"Jogos ao pôr do sol com montanhas ao fundo"}],"miami":[{icon:"🏟️",text:"Jogado no Hard Rock Stadium, casa do Dolphins"},{icon:"🌴",text:"Mudou de Key Biscayne pro estádio em 2019"},{icon:"🇧🇷",text:"Guga chegou à final em 2001"},{icon:"💨",text:"Vento forte do mar é um desafio constante"},{icon:"🎉",text:"Atmosfera festiva: mistura esporte e entretenimento"}],"barcelona":[{icon:"🧱",text:"Real Club de Tenis Barcelona: fundado em 1899"},{icon:"👑",text:"Nadal venceu 12 vezes — domínio quase total"},{icon:"🏟️",text:"Quadra central com vista para colinas de Barcelona"},{icon:"📜",text:"Um dos ATP 500 mais tradicionais do saibro"},{icon:"🇪🇸",text:"Ponto alto da temporada de saibro espanhola"}],"rio open":[{icon:"🇧🇷",text:"Único ATP 500 da América do Sul"},{icon:"🏟️",text:"Jogado no Jockey Club, em frente à Lagoa"},{icon:"🎉",text:"Atmosfera única: samba, calor e torcida"},{icon:"👑",text:"Guga nunca jogou — torneio começou em 2014"},{icon:"🏆",text:"1º título ATP do João Fonseca!"}]};

...
function BioCard({ player, season }) {
  ...
  const country = player?.country || "Brasil";
  ...
  return (
    <Card>
      <div style={{ display: "flex", gap: 14, alignItems: "center", marginBottom: 16 }}>
        <div style={{ width: 74, height: 74, borderRadius: 20, overflow: "hidden", flexShrink: 0 }}>
          <img src={FONSECA_IMG} alt="João Fonseca" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
        <div>
      ...
      <p style={{ margin: 0, fontSize: 15, lineHeight: 1.65, color: C.sub, fontFamily: SANS }}>
        João Fonseca é uma das maiores promessas do tênis brasileiro. Com apenas {age} anos, já compete em grandes torneios, soma vitórias importantes no circuito e chama atenção pela potência, personalidade e maturidade competitiva.
      </p>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginTop: 16 }}>
        <StatPill label="País" value={country === "Brasil" || country === "Brazil" ? "🇧🇷 BR" : country} accent={C.green} />
...
export default function HomeMatchdayV4() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg }}>
      <Head>
        ...
        <meta name="description" content="Homepage matchday v4" />
      </Head>
        ...
        <section style={{ paddingBottom: 24 }}>
          ...
          <Card>
            <div style={{ display: "flex", gap: 14, alignItems: "center", marginBottom: 16 }}>
              ...
              <div>
                <div style={{ fontSize: 28, fontWeight: 800, color: C.text, fontFamily: SERIF, lineHeight: 1.05 }}>João Fonseca</div>
                <div style={{ fontSize: 14, color: C.sub, fontFamily: SANS, marginTop: 6 }}>Tenista brasileiro · {player?.age || 18} anos · ranking ATP #{player?.ranking || 35}</div>
              </div>
            </div>
            <p style={{ margin: 0, fontSize: 15, lineHeight: 1.65, color: C.sub, fontFamily: SANS }}>
              João Fonseca é uma das maiores promessas do tênis brasileiro. Ainda muito jovem, já disputa grandes torneios, soma vitórias relevantes no circuito e chama atenção pela potência, personalidade e maturidade competitiva.
            </p>
          </Card>
        </section>
